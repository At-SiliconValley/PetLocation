...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, W5500_RST_Pin|LoRa_RST_Pin|LoRa_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : W5500_RST_Pin LoRa_RST_Pin LoRa_CS_Pin */
  GPIO_InitStruct.Pin = W5500_RST_Pin|LoRa_RST_Pin|LoRa_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
